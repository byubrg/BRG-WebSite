...
function start_enqueue_scripts() {
	...
	wp_enqueue_style( 'accordian-skin-2', $css_dir . '/accordian-skin2.css',null, $version_number );
	wp_enqueue_style( 'divider-page-css', $css_dir . '/divider-page.css', null,$version_number );
